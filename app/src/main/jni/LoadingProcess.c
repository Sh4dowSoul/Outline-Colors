...
Java_com_schnettler_outlinecolors_SubstratumLauncher_getAPStatus(JNIEnv *env) {
    return JNI_FALSE;
}
...
Java_com_schnettler_outlinecolors_SubstratumLauncher_getBase64Key(JNIEnv *env) {
 ...
 */
JNIEXPORT jstring JNICALL
Java_com_schnettler_outlinecolors_SubstratumLauncher_getAPKSignatureProduction(JNIEnv *env) {
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_schnettler_outlinecolors_SubstratumLauncher_getInternetCheck(JNIEnv *env) {
    return JNI_FALSE;
}
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_schnettler_outlinecolors_SubstratumLauncher_getGooglePlayRequirement(JNIEnv *env) {
    return JNI_FALSE;
}
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_schnettler_outlinecolors_SubstratumLauncher_getAmazonAppStoreRequirement(JNIEnv *env) {
    return JNI_FALSE;
}
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_schnettler_outlinecolors_SubstratumLauncher_getBlacklistedApplications(JNIEnv *env) {
    return JNI_FALSE;
}
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_schnettler_outlinecolors_SubstratumLauncher_allowThirdPartySubstratumBuilds(JNIEnv *env) {
    return JNI_TRUE;
}
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_schnettler_outlinecolors_SubstratumLauncher_getSamsungSupport(JNIEnv *env) {
    return Java_com_schnettler_outlinecolors_SubstratumLauncher_allowThirdPartySubstratumBuilds(env);
}
